...
class Header extends React.PureComponent<HeaderProps> {
  ...
  private onNumDownsampledDataPointsChange = (event: ChangeEvent<HTMLSelectElement>, numDownsampledDataPoints: number): void => {
  ...
  render(): React.ReactNode {
    return <div className={this.props.classes.paper}>
      <p>
        This is a demo playground for <a href="https://www.npmjs.com/package/downsample">downsample</a> npm module (<a href="https://github.com/janjakubnanista/downsample/">github</a>).
      </p>
